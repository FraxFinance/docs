...
This guide demonstrates how to use the Fraxnet contract system to mint frxUSD cross-chain using **USDC** on Ethereum mainnet. The Fraxnet system allows you to mint frxUSD on one chain (e.g., Base mainnet) while using USDC from another chain (e.g., Ethereum mainnet).
