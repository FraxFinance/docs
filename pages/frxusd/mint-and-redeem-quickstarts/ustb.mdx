...
const ETHEREUM_MAINNET_FRXUSD_MINT_AND_REDEEM_USTB_CUSTODIAN =
  '0x4F95C5bA0C7c69FB2f9340E190cCeE890B3bd87c'; // Mint & Redeem contract address using USTB

// frxUSD and USTB Addresses
const ETHEREUM_MAINNET_FRXUSD_ADDRESS = '0xfc00000000000000000000000000000000000001'; // frxUSD address on Ethereum mainnet
const ETHEREUM_MAINNET_USTB_ADDRESS = '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'; // USTB address on Ethereum mainnet
