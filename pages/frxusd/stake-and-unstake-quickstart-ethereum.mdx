...
const ETHEREUM_MAINNET_HOP_ADDRESS = '0x99b5587ab54a49e3f827d10175caf69c0187bfa8';
...
const ETHEREUM_MAINNET_FRXUSD_ADDRESS = '0xCAcd6fd266aF91b8AeD52aCCc382b4e165586E29';
const ETHEREUM_MAINNET_SFRXUSD_ADDRESS = '0xcf62F905562626CfcDD2261162a51fd02Fc9c5b6';
...
async function stakeOrUnstakeFrxusd(lockboxAddress, amount) {
  ...
  const nativeFee = await retrieveQuote(lockboxAddress, amount);
