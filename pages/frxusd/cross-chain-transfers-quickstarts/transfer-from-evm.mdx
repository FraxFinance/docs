...
### 2. Set up wallet client and public client
...
In this step, you call the `quote` function from the RemoteHop contracts deployed on **Ethereum mainnet** and **Arbitrum mainnet** to get the native fee amounts required for each respective transfer. You specify the following parameters:
...
// Recipient address
const DESTINATION_ADDRESS = '0x68a1e5b239BFa068d6231E80C64c5D7fFBf9CEe4'; // Enter your recipient wallet address here
