...
FraxNet introduces a cross-chain infrastructure that enables users to mint frxUSD on one blockchain while using assets from another. This system leverages LayerZero technology and specialized smart contracts to provide seamless cross-chain functionality.
...
- LayerZero's proven cross-chain messaging protocol
