...
**Note:** The method for staking and unstaking frxUSD on Fraxtal is different from the method for staking and unstaking frxUSD on all other EVM chains. See the [Stake & Unstake frxUSD on EVM chains](/frxusd/stake-and-unstake-quickstart-evm-chains) and [Stake & Unstake frxUSD on Ethereum](/frxusd/stake-and-unstake-quickstart-ethereum) guides for more information.
