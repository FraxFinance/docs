...
Te FraxNet contract system allows for cross-chain frxUSD mint & redeem operations. This system enables minting and redeeming frxUSD across multiple networks including Fraxtal, Arbitrum, Base, and others using **USDC** as the payment or redemption asset. The same factory contract powers [FraxNet](https://net.frax.com):
...
Cross-chain minting is supported on **all listed chains below** where EID is how to specify which chain to mint frxUSD to.
